  ...
  },
  {
    ...
    operations: [
      ...
      },
      {
        ...
        status: 'Completed',
        date: 'August 29, 2026',
        name: 'Lucy Ford (O1D.local/Test OU)',
        reason: 'Updated contact details',
        requestedAt: 'August 29, 2026 14:36:08 UTC',
        logonComputer: 'ActiveRolesVm2.O1D.local',
        logonSite: 'Default-First-Site-Name',
        activeRolesAdmin: 'Yes',
        targetObject: 'Lucy Ford (O1D.local/Test OU)',
        lastUpdatedOn: 'August 29, 2026 14:36:08 UTC',
        changes: [
          {
            property: 'Phone Number',
            attribute: '(telephoneNumber)',
      ...
      },
      {
        ...
        date: 'August 29, 2026',
        name: 'Lucy Ford (O1D.local/Test OU)',
        reason: 'Helpdesk access requested',
        requestedAt: 'August 29, 2026 14:21:44 UTC',
        logonComputer: 'ActiveRolesVm2.O1D.local',
        logonSite: 'Default-First-Site-Name',
        activeRolesAdmin: 'Yes',
        targetObject: 'Helpdesk (O1D.local/Test OU)',
        lastUpdatedOn: 'August 29, 2026 14:21:44 UTC',
        changes: [
          {
            property: 'Member Of',
            attribute: '(memberOf)',
    ...
    operations: [
      {
        ...
        date: 'August 25, 2026',
        name: 'Lucy Ford (O1D.local/Test OU)',
        reason: 'Reactivated after manager review',
        requestedAt: 'August 25, 2026 14:44:27 UTC',
        logonComputer: 'ActiveRolesVm.O1D.local',
        logonSite: 'Default-First-Site-Name',
        activeRolesAdmin: 'Yes',
        targetObject: 'Lucy Ford (O1D.local/Test OU)',
        lastUpdatedOn: 'August 25, 2026 14:44:27 UTC',
        changes: [],
      },
    ],
  },
    ...
    operations: [
      {
        ...
        date: 'August 23, 2026',
        name: 'Lucy Ford (O1D.local/Test OU)',
        reason: 'Temporary deprovisioning request',
        requestedAt: 'August 23, 2026 14:39:11 UTC',
        logonComputer: 'ActiveRolesVm.O1D.local',
        logonSite: 'Default-First-Site-Name',
        activeRolesAdmin: 'Yes',
        targetObject: 'Lucy Ford (O1D.local/Test OU)',
        lastUpdatedOn: 'August 23, 2026 14:39:11 UTC',
        changes: [
          {
            property: 'Account Status',
            attribute: '(userAccountControl)',
